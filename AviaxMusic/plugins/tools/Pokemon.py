...
async def CutexMusic(client, message):
    ...
    if len(command_parts) < 2:
        await message.reply_text("Please provide a Pokémon name.")
        return
    ...
    try:
        ...
        response_message += f"Abilities: {abilities}\n"
        response_message += "Stats:\n"
        ...
        # AHHHHH FINNALY DONE 
        await message.reply_photo(photo=poke_img_url, caption=response_message, parse_mode=ParseMode.MARKDOWN)
        ...
        await message.reply_text("Pokemon was not found.")
